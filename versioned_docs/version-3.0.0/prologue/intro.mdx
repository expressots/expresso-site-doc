...
> **PROLOGUE**: Provides release notes and upgrade guides information and outlines the structure of the documentation.
...
**[Links](https://doc.expresso-ts.com)**: Bold green text indicates hyperlinks to other documentation pages or external resources.

```md
[Links](https://doc.expresso-ts.com)
```
