...
| ------------ | ------------------------- | ------- | --------------------------------------------------------------------------------------------- |
| `path`       | every schematic           | —       | The resource path. Two forms: `folder/name` or shorthand `folder-name`. See [Path forms](#path-forms). |
...
| `--method` `-m` | `controller`, `service`| —       | Shorthand for the `method` positional, e.g. `-m post`.                                       |
