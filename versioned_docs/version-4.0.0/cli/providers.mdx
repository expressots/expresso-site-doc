---
sidebar_position: 4
title: Providers (add / remove / create)
description: Install, uninstall, and scaffold ExpressoTS providers from the CLI.
---

# Providers

ExpressoTS providers are npm packages that drop pluggable functionality into your app — auth strategies, database adapters, log transports, message queues, etc. The CLI gives you three commands to work with them:
