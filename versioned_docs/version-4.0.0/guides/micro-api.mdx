...
- **Responses are buffered, not streamed** — the adapter collects the whole body before returning it.
...
- **Bundle size.** A minimal Worker is roughly 535 KB gzipped — comfortably under the 3 MB free-tier limit, but heavy for the edge, since Express and its dependencies dominate.
