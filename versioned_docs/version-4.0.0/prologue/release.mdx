...
| Studio (preview) | Local developer experience platform: request timeline, architecture map, live logs, error inspector, security view, MCP server |

## Versioning Scheme

ExpressoTS follows [Semantic Versioning](https://semver.org/):

- **Major**: Breaking changes (yearly, Q4/Q1)
...
-   `@expressots/cli`
-   `@expressots/studio` (preview)
-   `@expressots/studio-agent` (preview)
-   `@expressots/mcp-server` (preview)

## Support Policy

Bug fixes and security patches are provided for 18 months after release. Enterprise customers with support contracts receive extended support.
...
ExpressoTS Studio adds a local developer experience platform on top of any v4 application. Everything runs on your machine; nothing is sent off the box.
