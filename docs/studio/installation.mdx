...
Starting with v4.0.0, the agent accepts a `mode` and `installId` configuration for future production telemetry and cloud features. See [Production & Telemetry](./production-telemetry.mdx) for details.
:::
