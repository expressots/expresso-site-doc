...
-   Lifecycles and Scoping: manage the lifecycle of injected objects, and control their scoping (e.g., singleton scope, request scope). See **[Lifecycle Hooks](./lifecycle.mdx)** for advanced lifecycle management.
