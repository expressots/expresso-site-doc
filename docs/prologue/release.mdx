...
**v4.0.0 is currently in preview** (`4.0.0-preview.3`). Install with `npm install @expressots/core@next` or scaffold a new project with `npx @expressots/cli@next new my-app`. APIs are stable but may receive minor refinements before GA.
:::
...
| ------- | ---------- | -------------- | -------------------------- | ------ |
| 4.0.0   | >= 20.18.0 | Jun 2026 (preview) | Jun 2028 (from GA)     | 🟣     |
| 3.0.0   | >= 20.18.0 | December 2024  | December 2026              | 🟢     |
| 2.0.0   | >= 18.10.0 | September 2023 | March 2025                 | 🔴     |

🟣 Preview 🟢 Active support 🟡 Bug & Security fixes only 🔴 End-of-life
...
```bash
npm install -D @expressots/studio@next @expressots/studio-agent@next
