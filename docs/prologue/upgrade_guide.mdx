...
sidebar_position: 2
title: Upgrade guide
description: Upgrade guide for ExpressoTS 4.0.0 (preview).
---
...
:::info
v4.0.0 is currently in **preview**. Install the preview packages with the `@next` dist-tag: `npm install @expressots/core@next @expressots/adapter-express@next`.
:::
