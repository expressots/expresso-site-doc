...
| containerize   | c            | Generate Dockerfile, Docker Compose, or Kubernetes manifests             |
| cicd           | ci, pipeline | Generate CI pipeline configuration for your platform of choice           |
| container-dev  | cdev         | Run the dev loop inside a Docker container with hot reload               |
